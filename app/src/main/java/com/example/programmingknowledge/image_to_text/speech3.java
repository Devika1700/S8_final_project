...
public class speech3 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(input.equals("was")) {
            ...
            textToSpeech.speak("The correct pronunciation is... was! Try again!!",TextToSpeech.QUEUE_FLUSH,null);
        }
    }
    public void onClick(View v) {
