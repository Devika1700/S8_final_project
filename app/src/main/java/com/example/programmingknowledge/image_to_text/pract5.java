...
public class pract5 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pract5);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.imageView19:
                if(playNoise==null){
                    playNoise= MediaPlayer.create(this,R.raw.j);
                }
                playNoise.start();
                break;
            ...
            case R.id.imageView20:
                if(playNoise2==null){
                    playNoise2= MediaPlayer.create(this,R.raw.u);
                }
                playNoise2.start();
                break;
            ...
            case R.id.imageView22:
                if(playNoise4==null){
                    playNoise4= MediaPlayer.create(this,R.raw.k);
                }
                playNoise4.start();
                break;
        }
