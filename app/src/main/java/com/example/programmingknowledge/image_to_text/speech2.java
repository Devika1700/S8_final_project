...
public class speech2 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(input.equals("how")) {
            ...
            textToSpeech.speak("The correct pronunciation is... how! Try again!!",TextToSpeech.QUEUE_FLUSH,null);
        }
    }
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.imageView5:
                startActivity(new Intent(this, speech3.class));
                break;
