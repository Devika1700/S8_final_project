    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.imageView9:
                textToSpeech.speak("FIND",TextToSpeech.QUEUE_FLUSH,null);

                break;

            case R.id.imageView11:
                if(playNoise==null){
                    playNoise= MediaPlayer.create(this,R.raw.f);
                }
                playNoise.start();
                break;
            ...
            case R.id.imageView16:
                if(playNoise4==null){
                    playNoise4= MediaPlayer.create(this,R.raw.d);
                }
                playNoise4.start();
                break;

            case R.id.imageView15:
                startActivity(new Intent(this,bone.class));
                break;
