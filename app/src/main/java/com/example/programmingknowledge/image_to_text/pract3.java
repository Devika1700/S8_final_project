...
public class pract3 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pract3);
        ...
        image6=findViewById(R.id.imageView15);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.imageView5:
                startActivity(new Intent(this, pract4.class));
                break;

            case R.id.imageView15:
                startActivity(new Intent(this, pract2.class));
                break;
            ...
            case R.id.imageView20:
                if(playNoise2==null){
                    playNoise2= MediaPlayer.create(this,R.raw.e);
                }
                playNoise2.start();
                break;
            ...
            case R.id.imageView21:
                if(playNoise3==null){
                    playNoise3= MediaPlayer.create(this,R.raw.d);
                }
                playNoise3.start();
                break;
        }
