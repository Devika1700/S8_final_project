...
public class zip extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.imageView9:
                textToSpeech.speak("ZIP",TextToSpeech.QUEUE_FLUSH,null);

                break;

            case R.id.imageView11:
                if(playNoise==null){
                    playNoise= MediaPlayer.create(this,R.raw.z);
                }
                playNoise.start();
                break;
            ...
            case R.id.imageView12:
                if(playNoise2==null){
                    playNoise2= MediaPlayer.create(this,R.raw.i);
                }
                playNoise2.start();
                break;
            ...
            case R.id.imageView13:
                if(playNoise3==null){
                    playNoise3= MediaPlayer.create(this,R.raw.p);
                }
                playNoise3.start();
                break;
