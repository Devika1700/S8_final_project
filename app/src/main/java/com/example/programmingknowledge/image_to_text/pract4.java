...
public class pract4 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pract4);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.imageView5:
                startActivity(new Intent(this, pract5.class));
                break;
            ...
            case R.id.imageView19:
                if(playNoise==null){
                    playNoise= MediaPlayer.create(this,R.raw.d);
                }
                playNoise.start();
                break;
            ...
            case R.id.imageView21:
                if(playNoise3==null){
                    playNoise3= MediaPlayer.create(this,R.raw.g);
                }
                playNoise3.start();
                break;
        }
